...
-- 
-- Gazda (Host): 10.1.1.30
-- Timp de generare: Iul 25, 2011 at 08:40 PM
-- Versiune server: 5.0.18
-- Versiune PHP: 5.2.13

SET SQL_MODE="NO_AUTO_VALUE_ON_ZERO";

-- 
-- Baza de date: `detecoro_1`
-- 
CREATE DATABASE `detecoro_1` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `detecoro_1`;

-- --------------------------------------------------------

-- 
-- Structura de tabel pentru tabelul `content`
-- 
...
-- 
-- Salvarea datelor din tabel `content`
-- 
...
('project_category_office', 'portfolio', '{"ro": "Birouri", "en": "Offices"}'),
('project_category_residential', 'portfolio', '{"ro": "Rezidențial", "en": "Residential"}'),
('project_category_hotel', 'portfolio', '{"ro": "Hoteluri", "en": "Hotels"}'),
('project_category_industrial', 'portfolio', '{"ro": "Industrial", "en": "Industrial"}'),
('project_category_commercial', 'portfolio', '{"ro": "Comercial", "en": "Commercial"}'),
('project_category_restoration', 'portfolio', '{"ro": "Restaurări", "en": "Restorations"}'),
('project_category_hospital', 'portfolio', '{"ro": "Spitale", "en": "Hospitals"}'),
('project_category_other', 'portfolio', '{"ro": "Diverse", "en": "Other"}'),
