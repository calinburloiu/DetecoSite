...
-- 
-- Host: 10.1.1.30
-- Generation Time: Aug 15, 2011 at 03:09 AM
...
('title', 'common', '{"ro":"DETECO, Proiectare în Instalații pentru Construcții","en":"DETECO, Design Engineering in Installations for Constructions"}'),
('description_home', 'article', '{"ro":"Oferim servicii de proiectare, verificare și consultanță în instalații pentru construcții.","en":"We offer services of design engineering, design checking and consulting in installations for constructions."}'),
('project_page', 'common', '{"ro": "Pagină de prezentare proiect", "en": "Project Page"}'),
('description_company', 'article', '{"ro":"Oferim servicii de proiectare pentru instalații sanitare, de stingere incendii, termice, de ventilație și electrice.","en":"We offer services of design engineering in installations: sanitary, fire fighting and detection, heating, ventilation and electrical."}'),
('description_team', 'article', '{"ro":"Ingineri Proiectanți și Asociați: Adrian Burloiu, Valentin Burloiu, Mihaela Burloiu","en":"Design Engineers and Parners: Adrian Burloiu, Valentin Burloiu, Mihaela Burloiu"}'),
('description_portfolio', 'portfolio', '{"ro":"Am proiectat clădiri de birouri, ansambluri rezidențiale, comerciale și industriale, hoteluri, spitale etc.","en":"We designed buildings for offices, residential, commercial and industrial parks, hotels, hospitals etc."}'),
('description_partners', 'article', '{"ro":"Colaborăm cu companii cu renume din domeniul construcțiilor și arhitecturii.","en":"We collaborate with renowned companies from the field of constructions and architecture."}'),
('description_contact', 'article', '{"ro":"Telefon: +40-744-753-221 sau +40-744-255-875; Adresă: Str. Mr. Alex Câmpeanu, nr. 66, bl. 37, parter, ap. 1; România, București, sect. 1","en":"Phone: +40-744-753-221 or +40-744-255-875; Address: 66 Mr. Alex Câmpeanu Street, flat 37, ground floor, apartment 1; Bucharest, district 1, Romania"}');
...
CREATE TABLE `portfolio` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_romanian_ci AUTO_INCREMENT=70 ;
